...
org 0064h ;here lies the codes for GLCD and GUI Related Operations
		...
		;r2 of reg b3
			...
			setb p2.4 ;set cs1 to select first half of glcd (actullay inverted logic is used for proteus simulation hence a bit change in these and rst instructions is seen)
			clr p2.5
			...
			right_half: ;logic for right of screen
				...
				clr p2.4 ;selecting right half of screen
				setb p2.5
...
org 343h ;lookup tables	for char ; black=1 ;upper nibble =lower 4 bits of 8 bits of col
		...
		snake:DB 38,111,73,73,123,50,0,0 ;S
			  ...
			  DB 127,127,73,73,65,65,0,0 ;E
		;characters of string WINS	
		wins: DB 127,127,48,24,48,127,127,0; W
			DB 65,65,127,127,65,65,0,0 ;I
			DB 127,127,6,12,24,127,127,0 ;N
			DB 38,111,73,73,123,50,0,0 ;S
...
org 085dh
		...
		set_column2: ;selects a particular column form where to write data for a given selected page
		
		clr c
		mov b,a ;copy a in b for book-keeping
		subb a,#40h ;check if the number in accumulator is greater than 64 in decimal to take decision
		jnc right_half2 ;jump to right half if number is >=64 in decimal
		...
		lcall cmdwrt ;call command function to select a particular column
		
		sjmp column_set2
		
		right_half2: ;logic for right of screen
		...
		setb p2.4 ;enable both displays to set same page on both
		setb p2.5
...
org 0e1fh
	...
	check_vertical: ;check the winning possiblity vertically
		...
		;to take a note that for which player score is been calculated
		cjne a,#01h,sc_of_pl2_v
		setb 02h
		sjmp cont_check_v
		sc_of_pl2_v:
		clr 02h
...
hpbmp:
			...
			db 0xF0, 0x88, 0x0C, 0x00, 0x04, 0x46, 0xE6, 0xF6, 0x66, 0x46, 0x42, 0x02, 0x02, 0x06, 0x46, 0x66
			db 0x64, 0x00, 0x00, 0x04, 0x04, 0x08, 0x8C, 0xC8, 0xC8, 0xE8, 0x78, 0x38, 0x30, 0x30, 0x10, 0x98
			db 0xD8, 0xD8, 0x78, 0x78, 0x78, 0xD8, 0xD8, 0x90, 0x90, 0x10, 0x30, 0x30, 0x60, 0xE0, 0xC0, 0x80
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x01, 0x03, 0x06, 0x04, 0x08, 0x18, 0x10, 0x20, 0x20, 0x60, 0x40, 0x80, 0x80, 0x80, 0x00
			db 0x00, 0x00, 0x00, 0x78, 0xFC, 0xFF, 0xFF, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x38, 0xFF, 0xFF
			db 0x01, 0x00, 0x30, 0x78, 0x78, 0x58, 0xD8, 0xD3, 0x1F, 0x1E, 0x1C, 0x18, 0x1C, 0xFF, 0xFF, 0xF4
			db 0x04, 0x0C, 0x08, 0x18, 0x10, 0x30, 0x20, 0x60, 0x40, 0xC0, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01
			db 0x03, 0x03, 0x02, 0x06, 0x07, 0x07, 0x07, 0x0F, 0x0C, 0x1C, 0x18, 0x18, 0x30, 0x30, 0x30, 0x33
			db 0x63, 0x66, 0x74, 0x74, 0x74, 0xB7, 0x93, 0x99, 0x98, 0x98, 0x30, 0x30, 0x30, 0x3F, 0x3F, 0x3F
			db 0x00, 0x20, 0x60, 0x20, 0x00, 0x00, 0x00, 0x10, 0x30, 0x70, 0x30, 0x11, 0x13, 0x06, 0x8C, 0xF8
			...
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x03
			db 0x03, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x01, 0x01, 0x01, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xC0, 0xC0, 0x60, 0xE0, 0xE0, 0xE0, 0xC0
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF8, 0xF0, 0x00, 0x00, 0x00, 0x00, 0xC0
			db 0xE0, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80
			db 0x80, 0x80, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0xE0, 0xF8, 0x1C, 0x0E, 0x03, 0x21, 0x31, 0xF0, 0xF0, 0xF0, 0xF3, 0xE3, 0xC0
			db 0x00, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x00, 0x03, 0xFF, 0xFE, 0x1C, 0x06, 0x07, 0x03
			db 0x01, 0xC0, 0xE0, 0xF0, 0x70, 0x38, 0x3C, 0x36, 0x33, 0xF9, 0xFF, 0x3F, 0x30, 0x10, 0x00, 0xC0
			db 0xF0, 0xFC, 0x1E, 0x0F, 0x3F, 0xFC, 0x80, 0xC0, 0xF0, 0x7C, 0x1F, 0x07, 0x01, 0x01, 0xE1, 0xFF
			db 0x0F, 0x01, 0x00, 0x00, 0x00, 0xC0, 0xFE, 0x1F, 0x07, 0x1B, 0x1B, 0x3D, 0x3D, 0x77, 0xE7, 0xC3
			db 0x80, 0xC0, 0xE0, 0x70, 0x38, 0x3C, 0x36, 0x33, 0xB1, 0xFF, 0xFF, 0x30, 0x30, 0x10, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x01, 0x07, 0x07, 0x07, 0x07, 0x06, 0x07, 0x07, 0x07, 0x03, 0x03, 0x03, 0x01
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x00, 0x00, 0x00, 0x00
			db 0x03, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x00, 0x00, 0x00, 0x00, 0x03
			db 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03
			db 0x00, 0x00, 0x00, 0x00, 0x02, 0x07, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03
			db 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
			db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
